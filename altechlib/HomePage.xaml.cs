    ...
    public sealed partial class HomePage : Page
    {
        public HomePage()
        {
            ...
            tblHomeContent.Text = "A library is a collection of sources of information and similar resources," +
                "made accessible to a defined community for reference or borrowing. It provides physical or digital access to material, and may be a physical building or room," +
                "or a virtual space, or both. A library's collection can include books, periodicals, newspapers, manuscripts, films, maps, prints, documents, microform, CDs," +
